...
export function FirmusLogoMark({ size = 28, light = false }: FirmusLogoProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" aria-hidden>
      ...
      <path d="M6 8 L6 24 L26 8 L26 24" stroke={navy} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function FirmusLogo({ size = 22, light = false, className }: FirmusLogoProps) {
  return (
