    ...
    <>
      <Tabs defaultValue="profile" className="mt-6">
        <TabsList>
          ...
          <TabsTrigger value="avail">Availability</TabsTrigger>
        ...
        <TabsContent value="pricing">
          <div className="max-w-[640px] space-y-6 rounded-xl border border-slate-100 bg-white-0 p-6">
            ...
            <Section title="Hourly equivalent (EUR)">
              <Input type="number" min={0} step="10" value={hourlyRate} onChange={(e) => setHourlyRate(Number(e.target.value))} />
            </Section>
