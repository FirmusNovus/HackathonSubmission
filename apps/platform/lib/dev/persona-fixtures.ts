...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    lawyerProfile: {
      ...
      bio: 'Fifteen years across employment disputes and EU Blue Card matters. Direct, written-first, available evenings.',
  ...
  },
  {
    ...
    lawyerProfile: {
      ...
      bio: 'Eleven years in Spanish real-estate transactions and SL incorporation. Bilingual ES/EN; fluent in cross-border tax structuring.',
  ...
  },
  {
    ...
    lawyerProfile: {
      ...
      bio: 'Italian + EU tax planning and trademark/copyright protection. Twelve years across freelancers, design studios, and e-commerce sellers.',
      specialties: ['Tax', 'IP'],
  ...
  },
  {
    ...
    lawyerProfile: {
      ...
      bio: 'Seven years advising Czech startups on incorporation, partner agreements, and EU GDPR-aligned data processing terms.',
