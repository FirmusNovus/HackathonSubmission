...
test.describe("Public marketing surfaces", () => {
  // TODO(phase-2): the "Sign In" link assertion is stale — the redesigned nav
  // uses the WalletButton CTA instead. Re-enable after connect+SIWE rewrite.
  test.skip("Landing — every primary control is wired", async ({ page }) => {
    await page.goto("/");
