#!/usr/bin/env bash
# scripts/dev-down.sh — stop the Next.js dev server.
#
# Usage:
#   ./scripts/dev-down.sh         # stop dev server (SQLite file is preserved)
