...
export default async function LawyerMessagesPage({
  ...
  const conversations = await prisma.conversation.findMany({
    ...
    include: {
      booking: { include: { client: true, lawyerProfile: true, engagement: true } },
    ...
    <div className="min-h-screen bg-white-50">
      ...
      <MessagesView
        ...
        threads={conversations.map((c) => {
          ...
          return {
            id: c.id,
            counterpartyUserId: c.booking?.client.id ?? "",
            counterpartyName:
            ...
            counterpartyEncryptionPublicKey: c.booking?.client.encryptionPublicKey ?? null,
