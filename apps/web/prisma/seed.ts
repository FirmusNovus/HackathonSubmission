...
const LAWYERS: SeedLawyer[] = [
  ...
  },
  {
    ...
    pricingKind: PricingKind.HOURLY,
    pricingHeadline: "0.12 ETH / hr",
    hourlyRateEUR: 0.12,
    consultationRate30: 0.07,
    consultationRate60: 0.12,
    pricingItems: [],
    rating: 4.8,
    reviewCount: 96,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.HOURLY,
    pricingHeadline: "0.055 ETH / hr",
    hourlyRateEUR: 0.055,
    consultationRate30: 0.0325,
    consultationRate60: 0.055,
    pricingItems: [],
    rating: 4.7,
    reviewCount: 73,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingHeadline: "from 0.1125 ETH",
    hourlyRateEUR: 0.045,
    consultationRate30: 0.0275,
    consultationRate60: 0.045,
    pricingItems: [
      { title: "Schengen visa application", desc: "Document review, application, follow-up", price: 0.1125, unit: "fixed" },
      { title: "EU residency permit", desc: "Full filing + 1 follow-up consultation", price: 0.3, unit: "fixed" },
      { title: "Family reunification", desc: "End-to-end with translations included", price: 0.6, unit: "fixed" },
    ],
    rating: 5.0,
    reviewCount: 211,
    verificationStatus: VerificationStatus.VERIFIED,
  ...
  },
  {
    ...
    pricingKind: PricingKind.FIXED,
    pricingHeadline: "from 0.0975 ETH",
    hourlyRateEUR: 0.08,
    consultationRate30: 0.05,
    consultationRate60: 0.08,
    pricingItems: [
      { title: "EU trademark filing", desc: "Search, classification, EUIPO submission", price: 0.0975, unit: "fixed" },
      { title: "Trademark + 1 jurisdiction", desc: "EU + your choice of national filing", price: 0.1725, unit: "fixed" },
      { title: "Cease & desist letter", desc: "Drafted and dispatched", price: 0.06, unit: "fixed" },
      { title: "Opposition response", desc: "Full response brief and filing", price: 0.3625, unit: "fixed" },
    ],
    rating: 4.9,
    reviewCount: 67,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingHeadline: "0.12 ETH / mo",
    hourlyRateEUR: 0.07,
    consultationRate30: 0.04,
    consultationRate60: 0.07,
    pricingItems: [
      { title: "Founder retainer", desc: "4 hours/mo · contracts, hiring, advice", price: 0.12, unit: "/ month" },
      { title: "Growth retainer", desc: "12 hours/mo · ongoing counsel", price: 0.3, unit: "/ month" },
      { title: "Italian S.r.l. setup", desc: "Entity formation + tax registration", price: 0.45, unit: "fixed" },
    ],
    rating: 4.8,
    reviewCount: 88,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.HOURLY,
    pricingHeadline: "0.09 ETH / hr",
    hourlyRateEUR: 0.09,
    consultationRate30: 0.0525,
    consultationRate60: 0.09,
    pricingItems: [],
    rating: 4.7,
    reviewCount: 58,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.FIXED,
    pricingHeadline: "from 0.15 ETH",
    hourlyRateEUR: 0.055,
    consultationRate30: 0.0325,
    consultationRate60: 0.055,
    pricingItems: [
      { title: "Spanish residency application", desc: "Full filing, in-person appointments", price: 0.15, unit: "fixed" },
      { title: "Golden visa", desc: "Investment-based residency, end-to-end", price: 0.875, unit: "fixed" },
      { title: "Citizenship application", desc: "Naturalization filing & oath prep", price: 0.45, unit: "fixed" },
    ],
    rating: 4.9,
    reviewCount: 124,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.SUBSCRIPTION,
    pricingHeadline: "0.2225 ETH / mo",
    hourlyRateEUR: 0.075,
    consultationRate30: 0.045,
    consultationRate60: 0.075,
    pricingItems: [
      { title: "Fractional DPO", desc: "Outsourced data protection officer", price: 0.2225, unit: "/ month" },
      { title: "GDPR audit", desc: "Full compliance review and gap analysis", price: 0.6, unit: "fixed" },
      { title: "DPIA", desc: "Data protection impact assessment", price: 0.275, unit: "fixed" },
    ],
    rating: 4.8,
    reviewCount: 54,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.HOURLY,
    pricingHeadline: "0.105 ETH / hr",
    hourlyRateEUR: 0.105,
    consultationRate30: 0.06,
    consultationRate60: 0.105,
    pricingItems: [],
    rating: 4.9,
    reviewCount: 79,
    verificationStatus: VerificationStatus.VERIFIED,
  },
  {
    ...
    pricingKind: PricingKind.HOURLY,
    pricingHeadline: "0.065 ETH / hr",
    hourlyRateEUR: 0.065,
    consultationRate30: 0.0375,
    consultationRate60: 0.065,
    pricingItems: [],
    rating: 4.7,
    reviewCount: 41,
    verificationStatus: VerificationStatus.VERIFIED,
      ...
      data: {
        ...
        lawyerProfile: {
          create: {
            ...
            headline: l.headline,
            bio: l.bio,
            specialties: stringifyJson(l.specialties),
            languages: stringifyJson(l.languages),
            jurisdictions: stringifyJson(l.jurisdictions),
            tags: stringifyJson(l.tags),
            ...
            pricingItems: stringifyJson(l.pricingItems),
            ...
            credentialDocsUrl: stringifyJson([]),
            rating: l.rating,
