...
import { issueAccessToken } from "@lex-nova/oid4vci";
import { getDb } from "@/lib/db";

export const runtime = "nodejs";

/**
 * Token endpoint. Pre-authorized code grant. Returns access_token + c_nonce.
 * DPoP header is accepted but not strictly validated — the pre-auth code
 * already gates this flow and the demo doesn't depend on DPoP's binding
 * property.
 */
